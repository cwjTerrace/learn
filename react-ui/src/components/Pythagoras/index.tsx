...
const color = interpolateRgb("purple", "orange");

const Pythagoras = ({ w, x, y, heightFactor, lean, left, right, lvl, maxlvl, enableSlowdown }) => {
  if (lvl >= maxlvl || w < 1) {
    return null;
  }
  ...
  return (
    <g transform={`translate(${x} ${y}) ${rotate}`}>
      <rect width={w} height={w} x={0} y={0} style={{ fill: color(lvl / maxlvl) }} />
